...
const disableCards = function() {
  ...
  else if(diff1 === "Normal" || diff2 === "Normal"){
    if(winCards === 8){
      winModal.classList.add("show_modal");
      clearTimeout(timer);
      winSound.play();
  ...
  else if(diff1 === "15 second" || diff2 === "15 second"){
    if(winCards === 5){
      winModal.classList.add("show_modal");
      clearTimeout(timer);
      winSound.play();
